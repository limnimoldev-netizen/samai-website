  ...
  if ($province) {
      ...
      foreach ($locations as $location) {
          ...
          $markers[] = [
                          ...
                          'subtitle' => get_post_meta($location->ID,'_subtitle',true),
                          'address'  => get_post_meta($location->ID,'_address',true),
                          'contact'  => get_post_meta($location->ID,'_contact',true),
                          'description' => get_post_meta($location->ID,'_description',true),
                      
                          'image' => get_the_post_thumbnail_url($location->ID,'large')
  ...
  <div id="venue-popup"
     class="hidden fixed inset-0 z-50 flex justify-end items-center bg-black/40">

    <?php get_template_part('template-parts/venue-detail-card'); ?>
...
markers.forEach(marker => {
    ...
    document.getElementById("close-card").addEventListener("click", function(e){
